...
namespace Qiniu.Conf
{
    public class Config
    {
         ...
         public static void Init()
        {
            ...
            {
                USER_AGENT = System.Configuration.ConfigurationManager.AppSettings["QN_ACCESS_KEY"];
            }
            if (System.Configuration.ConfigurationManager.AppSettings["QN_ACCESS_KEY"] != null)
            {
                ACCESS_KEY = System.Configuration.ConfigurationManager.AppSettings["QN_ACCESS_KEY"];   
            }
            if (System.Configuration.ConfigurationManager.AppSettings["QN_SECRET_KEY"] != null)
            {
                SECRET_KEY = System.Configuration.ConfigurationManager.AppSettings["QN_SECRET_KEY"];  
            }
